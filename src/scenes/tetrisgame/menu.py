...
class Menu(BaseMenu):
    ...
    def __init__(self):
        ...
        self._uiElements[3].set_on_mouse_click(lambda: app.App.set_current_scene(Game(self.starting_level))) # Start's the game
    ...
    def _increment_starting_level(self):
        ...
        if self.starting_level < 0 or self.starting_level >= len(gv.LEVEL_FPS):
            self.starting_level -= 1
        self._uiElements[2].set_text("Level: " + str(self.starting_level))
